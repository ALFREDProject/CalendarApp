...
public class CalendarView extends ImageView {
	...
	public void initCalendarView(Context context) {

		mRightNow = Calendar.getInstance(Locale.ENGLISH);
		// prepare static vars
			...
			for(int day=0; day<mCells[week].length; day++) {
				if(tmp[week][day].thisMonth) {
					if(day==0 || day==6 )
						...
						mCells[week][day] = new Cell(tmp[week][day].day, new Rect(Bound), CELL_TEXT_SIZE, getContext());
				} else {
	...
	public class GrayCell extends Cell {
		public GrayCell(int dayOfMon, Rect rect, float s) {
			super(dayOfMon, rect, s,getContext());
